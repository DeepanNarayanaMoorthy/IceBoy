...
======================================================================
# IceBoy
Ice boy is a full duplex chat software for two persons **A** and **B** connected to the same network.But all of this is nothing but a cover for more interesting process that would be running below.This is essentially a surveillance system disguised as a chat app. 
